    ...
    <body>
        <nav class="navbar navbar-light bg-light navbar-expand-lg">
            <div class="container-fluid">
                <a href="<?=$router->url('home')?>" class="navbar-brand">
                ...
                <div class="collapse navbar-collapse" id="main">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link text-uppercase <?php if($title=='panier'){echo 'active';}?>" href="<?=$router->url('panier')?>">panier</a></li>
                    </ul>
                </div>
            </div>
        </nav>
